...
namespace Diet.Api.Data.Migrations
{
    ...
    [Migration("20200208042052_AddCalorieStatusToMeal")]
    partial class AddCalorieStatusToMeal
    {
            ...
            modelBuilder.Entity("Diet.Api.Domain.Account", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("96d63772-d7dc-4dcc-87e1-e1aa0a58ddef"),
                            Email = "admin@domain.com",
                            PasswordHash = "AAAAAAEAAAAQWjxUNna4xiVO224dSleHlCOddJexHidWfVZTg5P8aBV43AkiirmQSufUhuXHTi24",
                            Role = "Admin"
                        });
                });
